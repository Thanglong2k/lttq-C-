...
{
    public partial class FormBC4 : Form
    {
        public FormBC4()
        {
            InitializeComponent();
        ...
        private void btnHienThi_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = BUSReport.KH_Thang(thang, nam);
            ReportParameter[] param = new ReportParameter[2];
            param[0] = new ReportParameter("Thang", thang.ToString());
            param[1] = new ReportParameter("Nam", nam.ToString());
            reportViewer1.LocalReport.ReportPath = "C:\\Users\\trant\\OneDrive\\Máy tính\\BTL\\GUI\\GUI\\FORMS\\FORM IN Báo cáo\\Report4.rdlc";
        ...
        private void FormBC4_Load(object sender, EventArgs e)
        {
